...
Partial Class AccountCreation
    ...
    Private Sub InitializeComponent()
        ...
        TextBox_Height.PlaceholderText = "Enter Height(cm)"
        ...
        TextBox_Weight.PlaceholderText = "Enter Weight(kg)"
        ...
        ' Button1
        ' 
        Button1.BackColor = Color.FromArgb(CByte(45), CByte(41), CByte(103))
